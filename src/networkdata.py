'''
This file contains functions to get network information from net.xml file through the sumolib API.
'''
...
class NetworkData:
    ...
    def find_destination_edges(self):
        '''
        wz: to find the destination edges, i.e. edges that are not the incoming edges of any other edges
        '''
    ...
    def find_origin_edges(self):
        '''
        wz: to find the origin edges, i.e. edges that are not the outgoing edges of any other edges
        '''
        next_edges = { e:0 for e in self.edge_data }
        for e in self.edge_data:
    ...
    def get_edge_data(self, net):
        # wz: return edges information in the net.xml file
        edges = net.getEdges()
